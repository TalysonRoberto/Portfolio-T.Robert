...
const TerminalCard = () => {
  return (
    <div className="bg-[#111318] border border-zinc-700 rounded-2xl overflow-hidden w-[70vw] md:w-[clamp(500px,50vw,850px)]">
      {/* topo terminal */}
      <div className="bg-[#1a1d24] border-b border-zinc-700 px-4 py-1 flex items-center justify-between">
        ...
        <div className="bg-white text-black text-xs px-4 rounded-sm  w-30 md:w-80">
          localhost:3000
        </div>
